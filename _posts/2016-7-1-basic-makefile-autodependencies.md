---
title: Modern Makefile for Mixed Assembly, C, and C++ Projects
excerpt: "This is a Makefile suitable for mixed Assembly, C, and C++ projects that uses build rules and GCC's autodependency feature."
permalink: mixed-modern-makefile
sitemap: true
---

This is a Makefile suitable for mixed Assembly, C, and C++ projects that uses build rules and GCC's autodependency feature. By passing in command line arguments, this makefile will build a Release or Debug binary.
